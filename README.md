...
## Server File
This file contains the backend server running a https://huggingface.co/r3ddkahili/final-complete-malicious-url-model which tells you whether the email is safe or malicious.
